...
namespace canvas
{
    ...
    public:
        ...
        void set_size(size_t width, size_t height, uint32_t default_color = 0);
        ...
        void draw_line(double x0, double y0, double x1, double y1, uint32_t color);

        void draw_towards(double x0, double y0, double x1, double y1, uint32_t color);

        void copy_sprite(int x0, int y0, size_t width, std::span<const uint32_t> pixels);
        void copy_sprite_masked(int x0, int y0, size_t width, std::span<const uint32_t> pixels);
        void draw_sprite(int x0, int y0, size_t width, std::span<const uint32_t> pixels);
    ...
    private:
        ...
        auto _clamp_relative(int x0, int y0, int x1, int y1) const -> std::tuple<int, int, int, int>;
